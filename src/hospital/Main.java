...
public class Main {
	...
	public static void main(String[] args) {
		...
		Hospital hospital=new Hospital("EsSalud", new ArrayList<Medico>(), new ArrayList<Paciente>());
		Paciente pacientePrueba1=new Paciente("01234567", "Lileth", "Av. Avenida", 50, 36);
		Paciente pacientePrueba2=new Paciente("74390128", "Qantu", "Calle los cachimbos", 50, 37);
		Paciente pacientePrueba3=new Paciente("72750855", "Dante", "Av. La Fontana", 55, 36);
		Paciente pacientePrueba4=new Paciente("74390128", "Valentina", "Jr de la unión", 43, 37);
		
		Medico medico1=new Medico(199, "Carlos", "Pediatra");
		Medico medico2=new Medico(200, "TV", "Traumatologo");
		...
		pacientePrueba3.setMedico(medico1);
		pacientePrueba4.setMedico(medico2);
